...
type FileHLSUploadHandler struct {
	BaseDir string
}

func (u *FileHLSUploadHandler) ServeHTTP(w http.ResponseWriter, req *http.Request) {
...
func (u *FileHLSUploadHandler) serveHTTPImpl(curFolderPath string, curFilePath string, w http.ResponseWriter, req *http.Request) {
