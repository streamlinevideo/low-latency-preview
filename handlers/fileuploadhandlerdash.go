...
type FileDashUploadHandler struct {
	BaseDir string
}

func (u *FileDashUploadHandler) ServeHTTP(w http.ResponseWriter, req *http.Request) {
...
func (u *FileDashUploadHandler) serveHTTPImpl(curFolderPath string, curFilePath string, w http.ResponseWriter, req *http.Request) {
